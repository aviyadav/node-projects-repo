...
const PowerBIVisualization = ({ data, selectedPoints, onPointSelect }) => {
  ...
  if (!usePowerBI) {
    return (
      <>
        <ChartControls>
          <ControlButton active={false} onClick={togglePowerBI}>
        ...
        <SetupGuide>
          ...
          <Step>
            ...
            <strong>Publish to Power BI:</strong> Upload your data to Power BI
            service
          </Step>

          <Step>
            <StepNumber>2</StepNumber>
            <strong>Create Visualizations:</strong> Build Scatter, Bar, Line,
            and Pie charts
          </Step>
  ...
  pieChart: 'YOUR_POWERBI_PIE_URL'
          ...
          <Step>
            ...
            <strong>Enable JavaScript API:</strong> Add Power BI interaction
            scripts to enable cross-chart selection
          </Step>
  ...
  return (
    <>
      <ChartControls>
        <ControlButton active={true} onClick={togglePowerBI}>
      ...
      <ChartsGrid>
        <ChartContainer>
          <PowerBIChart
            ...
            embedUrl={mockPowerBIUrls.scatterChart}
        ...
        <ChartContainer>
          <PowerBIChart
            ...
            embedUrl={mockPowerBIUrls.barChart}
            onChartClick={handleChartPointSelect}
            selectedIds={selectedPoints}
          />
        </ChartContainer>
        ...
        <ChartContainer>
          <PowerBIChart
            ...
            embedUrl={mockPowerBIUrls.lineChart}
            onChartClick={handleChartPointSelect}
            selectedIds={selectedPoints}
          />
        </ChartContainer>
        ...
        <ChartContainer>
          <PowerBIChart
            ...
            embedUrl={mockPowerBIUrls.pieChart}
            onChartClick={handleChartPointSelect}
            selectedIds={selectedPoints}
          />
        </ChartContainer>
      ...
      >
        <strong>Power BI Charts:</strong> Click on any data point in Power BI
        visualizations to select it. Selected points will filter the table
        below. Use the setup guide above to configure your Power BI embed URLs.
      </div>
    </>
  );
};
