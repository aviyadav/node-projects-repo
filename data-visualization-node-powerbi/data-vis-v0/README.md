...
- **Dynamic Chart Visualizations**: Scatter plots with multiple viewing modes
...
- Choose from three visualization modes:
  ...
  - Sales vs Rating  
  - Quantity vs Rating
- Click on data points to select/deselect them
- Selected points appear in red and filter the table
